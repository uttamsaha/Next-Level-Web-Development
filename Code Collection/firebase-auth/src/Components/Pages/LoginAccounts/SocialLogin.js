  ...
  return (
    <div>
        ...
        <div className='flex flex-col w-1/4  mx-auto'>
            <button className='bg-orange-700 h-12 mt-4 text-white' onClick={() => signInWithGoogle()}>Google Login</button>
            <button className='bg-blue-950 text-white h-12 mt-2'>Github Login</button>
        </div>
    </div>
  )
}
